...
export const translations = {
  es: {
    ...
    tourAnnotationTitle: "✦ ¿Cómo se crea este tour digital?",
    tourAnnotationText: "Diseñamos y creamos recorridos digitales inmersivos de alta calidad basados en fotos reales de tus propiedades. Sin necesidad de gastar en costosas cámaras de 360 grados ni perder tiempo en grabaciones complejas. Todo se genera de manera eficiente partiendo de fotografías estándar.",
  ...
  en: {
    ...
    tourAnnotationTitle: "✦ How is this digital tour created?",
    tourAnnotationText: "We design and create high-quality immersive digital tours based entirely on real photos of your properties. No need to invest in expensive 360-degree cameras or spend hours recording on-site. Everything is efficiently generated using standard photographs.",
